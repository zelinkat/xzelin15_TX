...
import static cz.vutbr.fit.xzelin15.dp.theatre.TheatreConstants.NUM_SEAT_AREAS;
 ...
 */
@WebService(serviceName="TheatreService", portName="TheatrePort", name = "Theatre", targetNamespace = "http://www.fit.vutbr.cz/xzelin15/DP/Theatre")
@HandlerChain(file = "/context-handlers.xml", name = "ContextHandler")
@WebServlet("/ITheatretServiceAT")
...
public class TheatreServiceAT implements ITheatreServiceAT
{
        ...
        int which_area)
    {
    	...
    	System.out.println("[TheatreService] " + how_many  + " " + which_area );
