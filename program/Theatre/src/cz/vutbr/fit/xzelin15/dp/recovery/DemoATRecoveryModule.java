...
import cz.vutbr.fit.xzelin15.dp.theatre.TheatreManager;
import cz.vutbr.fit.xzelin15.dp.theatre.TheatreParticipantAT;
...
public class DemoATRecoveryModule implements XTSATRecoveryModule
{
    ...
    {
        if (id.startsWith("org.jboss.jbossts.xts-demo:theatreAT")) {
