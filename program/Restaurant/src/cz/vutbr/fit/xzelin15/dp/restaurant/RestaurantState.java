...
import static cz.vutbr.fit.xzelin15.dp.restaurant.RestaurantConstants.DEFAULT_SEATING_CAPACITY;
...
public class RestaurantState extends ServiceState {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 9007454198764199284L;
	int totalSeats;
    int bookedSeats;
    int freeSeats;
