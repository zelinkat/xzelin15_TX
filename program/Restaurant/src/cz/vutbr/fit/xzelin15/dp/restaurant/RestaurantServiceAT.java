 ...
 */
@WebService(serviceName="RestaurantService", portName="RestaurantPort", name = "Restaurant", targetNamespace = "http://www.fit.vutbr.cz/xzelin15/DP/Restaurant")
...
public class RestaurantServiceAT implements IRestaurantServiceAT
{
    ...
    public void bookSeats(
            ...
            int how_many)
    {
    	//System.out.println("[RestaurnatService] " + how_many );
